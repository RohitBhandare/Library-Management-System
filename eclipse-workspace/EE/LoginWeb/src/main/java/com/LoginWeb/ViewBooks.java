...
public class ViewBooks extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		out.println("<tr><th>Book Id</th><th>Name</th><th>Author</th><th>Quantity</th><th>Issued</th><th>Delete</th></tr>");
		out.print("<style>th{background-color:aqua;}</style>");
		for(BookBean bean:list){
			out.println("<tr><td>"+bean.getBookID()+"</td><td>"+bean.getName()+"</td><td>"+bean.getAuthor()+"<font color:green></td><td>"+bean.getQuantity()+"</td><td></font>"+bean.getIssued()+"</td><td><a href='DeleteBook?callno="+bean.getQuantity()+"'>Delete</a></td></tr>");
		}
		out.println("</table>");
